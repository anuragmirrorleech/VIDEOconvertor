...
async def source(event):
    await event.edit(source_text,
                    buttons=[[
                         Button.url("FOR PERSONAL USE", url="https://github.com/AM-ROBOTS/videoconvertor/tree/main"),
                         Button.url("FOR YOUR CHANNEL ", url="https://github.com/AM_ROBOTS/videoconvertor/")]])
